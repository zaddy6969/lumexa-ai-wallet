...
function ConnectedWalletExperience({ initialView, initialReceiveOpen, walletSnapshot }) {
  ...
  const actionForView =
    activeView === "swap" && preparedAction?.tool === "prepare_swap"
      ? preparedAction
      : activeView === "bridge" && preparedAction?.tool === "prepare_bridge"
        ? preparedAction
        : activeView === "send" && preparedAction?.tool === "prepare_send"
          ? preparedAction
          : null;
        ...
        <div className="wallet-main" id="wallet-content">
          {activeView === "dashboard" ? (
            ...
            <>
              ...
              <SwapPanel
                key={actionForView?.id || "swap"}
                walletSnapshot={walletSnapshot}
                onActivitySaved={saveLocalActivity}
                copilotAction={actionForView}
              />
            </>
          ) : activeView === "bridge" ? (
            <>
