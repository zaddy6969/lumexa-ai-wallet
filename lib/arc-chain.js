...
export const ARC_NETWORK_MODE =
  String(process.env.NEXT_PUBLIC_ARC_NETWORK || "mainnet").toLowerCase() === "mainnet"
    ? "mainnet"
    : "testnet";
...
export const ARC_PUBLIC_TESTNET_NETWORK_CONFIG = {
  ...
  webSocketUrl: process.env.NEXT_PUBLIC_ARC_TESTNET_WS_URL || "wss://rpc.testnet.arc.io",
  currencySymbol: "USDC",
...
export const ARC_MAINNET_NETWORK_CONFIG = {
  ...
  currencySymbol: "USDC",
  explorerUrl: process.env.NEXT_PUBLIC_ARC_MAINNET_EXPLORER_URL || "https://explorer.arc.io"
};
...
export const ARC_MAINNET_ENABLED =
  String(process.env.NEXT_PUBLIC_ARC_MAINNET_ENABLED || "true").toLowerCase() === "true";
...
export const ARC_USDC_SYSTEM_ADDRESS = "0xffffFFFfFFffffffffffffffFfFFFfffFFFfFFfE";
...
// Verified against https://docs.arc.io/arc/references/contract-addresses on 2026-09-22.
...
export const ARC_MAINNET_EURC_ERC20_ADDRESS =
  process.env.NEXT_PUBLIC_ARC_MAINNET_EURC_ADDRESS || "0xbEf5f6d51CB62b58e6A8f77868681825C6fe21c1";
...
export const hasWalletConnectProjectId = /^[a-f0-9]{32}$/i.test(walletConnectProjectId);
